...
public class StrategoAttributesParseControllerGenerated extends DynamicParseController 
{ 
  ...
  { 
    StrategoAttributesParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = StrategoAttributesParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = StrategoAttributesParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(StrategoAttributesParseControllerGenerated.class);
    }
